export default {
  ...
  agentEditor: {
    ...
    im: {
      ...
      whatsappQRExpired: 'QR 코드가 만료되었습니다. 클릭하여 새로고침하세요',
      whatsappAllowFrom: 'DM 허용 목록',
      whatsappAllowFromHint: '1:1 채팅에서 봇을 호출할 수 있는 전화번호 목록(쉼표 구분, 국가번호 포함, 예: 8613800138000). "*"는 모두 허용, 비워두면 모든 DM을 거부합니다. 그룹에서는 {\'@\'}멘션하거나 봇 메시지에 답장할 때 응답합니다.',
      statusConnected: '연결됨',
      statusConnecting: '연결 중…',
      statusLoggedOut: '페어링이 해제되어 다시 페어링이 필요합니다',
      statusNeedsPairing: '페어링되지 않음 — QR 코드를 스캔하세요',
      statusStreamReplaced: '다른 클라이언트가 세션을 가져갔습니다',
      statusNotRunning: '실행 중이 아님',
      statusError: '연결 오류',
  ...
  model: {
    ...
    editor: {
      ...
      codex: {
        ...
        oauthLabel: 'ChatGPT 로그인',
        oauthButton: 'ChatGPT 계정으로 인증',
        oauthButtonAgain: '다시 인증',
        oauthWaiting: '인증 페이지가 열렸습니다 — 팝업에서 ChatGPT 로그인을 완료해 주세요…',
        oauthSuccess: '{account}로 인증됨 — 토큰이 자동 입력되었습니다',
        oauthSuccessSaved: '{account}로 인증됨 — 자격 증명이 이 모델에 저장되었습니다',
        oauthSuccessNoProfile: '인증 완료 — 토큰이 자동 입력되었습니다',
        oauthCredentialSaved: '자격 증명이 갱신되었습니다 (access + refresh token)',
        oauthFailed: '인증에 실패했습니다. 다시 시도해 주세요',
        oauthExpired: '인증 절차가 만료되었습니다. 버튼을 다시 눌러 주세요',
        oauthTimeout: '인증 대기 시간이 초과되었습니다. 버튼을 다시 눌러 주세요',
        oauthListenerDown: '백엔드가 localhost:1455 포트를 열지 못했습니다(포트 사용 중?). 로그인 후 브라우저가 열리지 않는 localhost:1455 페이지에 머무르면 주소창의 전체 URL을 위 입력란에 붙여넣어 주세요.',
        oauthHint: 'auth.openai.com이 열리고 ChatGPT 로그인 후 토큰이 자동 입력되며 만료 시 자동 갱신됩니다. 브라우저가 WeKnora와 다른 기기라면 마지막 localhost:1455 주소를 입력란에 붙여넣어 주세요.',
        oauthPastePlaceholder: 'localhost:1455로 이동이 안 되나요? 주소창의 전체 URL을 여기에 붙여넣으세요',
        oauthPasteSubmit: '제출',
        refreshTokenLabel: 'Refresh Token',
        refreshTokenPlaceholder: 'refresh_token 입력 (access token 만료 시 자동 갱신)',
        authJsonLabel: '또는 ~/.codex/auth.json에서 직접 가져오기',
  ...
  chat: {
    ...
    channelApi: 'API',
    channelIm: 'IM',
    channelImTakeover: '상담원 인수 중 수신',
    imManualBanner: '{platform}에서 온 대화: 여기서 보낸 내용은 AI 답변 없이 상담원 답장으로 상대방에게 직접 전송됩니다',
    imManualSent: '상대방에게 전송되었습니다',
    imManualSendFailed: '수동 답장 전송에 실패했습니다',
    imManualTag: '상담원 답장',
    imManualImageNoPreview: '이미지 {name}이(가) 전송되었습니다(용량 초과로 미리보기는 저장되지 않음)',
    imTakeoverStart: '대화 인수하기',
    imTakeoverRelease: '봇에게 돌려주기',
    imTakeoverActive: '상담원 인수 중: 봇이 응답하지 않으며 이 대화는 직접 답변합니다',
    imTakeoverActiveUntil: '상담원 인수 중: 봇이 응답하지 않으며 상담원 답장이 없으면 {time}에 자동 복귀합니다',
    imTakeoverFor30m: '30분 동안 인수',
    imTakeoverFor1h: '1시간 동안 인수',
    imTakeoverFor4h: '4시간 동안 인수',
    imTakeoverIndefinite: '수동으로 돌려줄 때까지 인수',
    imTakeoverStarted: '인수했습니다 — 이 대화에서 봇이 응답하지 않습니다',
    imTakeoverReleased: '봇에게 돌려주었습니다',
    imTakeoverFailed: '인수 상태 업데이트에 실패했습니다',
    chunkLabel: '청크 {index}:',
  ...
  input: {
    ...
    placeholderManualIm: '수동 답장을 입력하세요. 상대방이 직접 받게 됩니다',
  ...
  // 운영자 수신함: IM 고객 응대 워크벤치
  imInbox: {
    title: 'IM 수신함',
    unreadTotalTip: '읽지 않은 메시지 총수',
    filterAll: '전체',
    filterHuman: '상담원 필요',
    filterUnread: '읽지 않음',
    empty: '아직 IM 대화가 없습니다',
    emptyFiltered: '조건에 맞는 대화가 없습니다',
    loading: '불러오는 중…',
    loadMore: '더 불러오기',
    loadOlder: '이전 메시지 불러오기',
    selectPrompt: '왼쪽에서 대화를 선택해 시작하세요',
    humanTag: '상담원 인계 중',
    roleUser: '사용자',
    roleAssistant: '봇',
    roleOperator: '상담원',
    takeover: '대화 인계',
    takeover30m: '30분 동안 인계',
    takeover1h: '1시간 동안 인계',
    takeover4h: '4시간 동안 인계',
    takeoverNoExpiry: '수동 반환까지 인계',
    takeoverActive: '상담원 인계 중, {time} 만료',
    takeoverActiveNoExpiry: '상담원 인계 중',
    takeoverStarted: '대화를 인계했습니다. 봇이 응답을 중지합니다',
    takeoverReleased: '봇에게 반환했습니다',
    takeoverRelease: '봇에게 반환',
    openInChat: '채팅 페이지에서 열기',
    composerPlaceholder: '답변을 입력하세요. Enter 전송, Shift+Enter 줄바꿈',
    composerUnsupported: '이 플랫폼은 아직 콘솔에서 직접 답변할 수 없습니다. 해당 IM 앱에서 응답해 주세요',
    send: '전송',
    sendFailed: '전송에 실패했습니다. 잠시 후 다시 시도해 주세요',
    actionFailed: '작업에 실패했습니다. 잠시 후 다시 시도해 주세요',
    loadFailed: '불러오기에 실패했습니다. 잠시 후 다시 시도해 주세요',
    quickReplies: '빠른 답변',
    quickRepliesManage: '빠른 답변 관리',
    quickRepliesHint: '한 줄에 한 문구, 최대 50개, 각 500자 이내. 워크스페이스의 모든 운영자가 공유합니다.',
    quickRepliesPlaceholder: '예: 안녕하세요! 무엇을 도와드릴까요?',
    quickRepliesSaved: '빠른 답변을 저장했습니다',
    save: '저장',
    cancel: '취소',
    channelTakeover: '상담원 인계 중 수신',
    channelManual: '상담원',
  },
  menu: {
    knowledgeBase: '지식베이스',
