export default {
  // Operator inbox: IM customer-service workbench
  imInbox: {
    title: 'IM Inbox',
    unreadTotalTip: 'Total unread messages',
    filterAll: 'All',
    filterHuman: 'Needs human',
    filterUnread: 'Unread',
    empty: 'No IM conversations yet',
    emptyFiltered: 'No conversations match this filter',
    loading: 'Loading…',
    loadMore: 'Load more',
    loadOlder: 'Load earlier messages',
    selectPrompt: 'Select a conversation on the left to get started',
    humanTag: 'Human takeover',
    roleUser: 'User',
    roleAssistant: 'Bot',
    roleOperator: 'Agent',
    takeover: 'Take over',
    takeover30m: 'Take over for 30 minutes',
    takeover1h: 'Take over for 1 hour',
    takeover4h: 'Take over for 4 hours',
    takeoverNoExpiry: 'Take over until released',
    takeoverActive: 'Human takeover, expires at {time}',
    takeoverActiveNoExpiry: 'Human takeover active',
    takeoverStarted: 'Conversation taken over; the bot is now silent',
    takeoverReleased: 'Handed back to the bot',
    takeoverRelease: 'Hand back to bot',
    openInChat: 'Open in chat',
    composerPlaceholder: 'Type a reply. Enter to send, Shift+Enter for a new line',
    composerUnsupported: 'Console replies are not supported for this platform yet; please answer in the IM app',
    send: 'Send',
    ...
    quickRepliesManage: 'Manage quick replies',
    quickRepliesHint: 'One phrase per line, up to 50 phrases of 500 characters each; shared by all operators of this workspace.',
    quickRepliesPlaceholder: 'e.g. Hello! How can I help you today?',
    quickRepliesSaved: 'Quick replies saved',
    save: 'Save',
    cancel: 'Cancel',
    channelTakeover: 'During human takeover',
    channelManual: 'Human agent',
  },
  menu: {
  ...
  input: {
    ...
    placeholderManualIm: 'Type a manual reply; the user will receive it directly',
  ...
  chat: {
    ...
    channelApi: 'API',
    channelIm: 'IM',
    channelImTakeover: 'During takeover',
    imManualBanner: 'Conversation from {platform}: messages you send here go directly to the user as a human reply and do not trigger an AI answer',
    imManualSent: 'Sent to the user',
    imManualSendFailed: 'Failed to send the manual reply',
    imManualTag: 'Human reply',
    imManualImageNoPreview: 'Image {name} was sent (too large to keep a preview)',
    imTakeoverStart: 'Take over',
    imTakeoverRelease: 'Hand back to bot',
    imTakeoverActive: 'Human takeover: the bot is muted, you answer this conversation',
    imTakeoverActiveUntil: 'Human takeover: the bot is muted and resumes automatically at {time} without operator replies',
    imTakeoverFor30m: 'Take over for 30 minutes',
    imTakeoverFor1h: 'Take over for 1 hour',
    imTakeoverFor4h: 'Take over for 4 hours',
    imTakeoverIndefinite: 'Take over until handed back',
    imTakeoverStarted: 'Taken over — the bot is muted in this conversation',
    imTakeoverReleased: 'Handed back to the bot',
    imTakeoverFailed: 'Failed to update the takeover state',
  ...
  model: {
    ...
    editor: {
      ...
      codex: {
        ...
        oauthLabel: 'ChatGPT sign-in',
        oauthButton: 'Sign in with ChatGPT',
        oauthButtonAgain: 'Re-authorize',
        oauthWaiting: 'Authorization page opened — finish the ChatGPT login in the popup…',
        oauthSuccess: 'Authorized as {account} — tokens filled in automatically',
        oauthSuccessSaved: 'Authorized as {account} — credentials saved to this model',
        oauthSuccessNoProfile: 'Authorized — tokens filled in automatically',
        oauthCredentialSaved: 'Credentials updated (access + refresh token)',
        oauthFailed: 'Authorization failed, please retry',
        oauthExpired: 'This login attempt expired — click the button to start again',
        oauthTimeout: 'Timed out waiting for authorization — click the button to start again',
        oauthListenerDown: 'The backend could not listen on localhost:1455 (port in use?). After signing in, the browser will land on an unreachable localhost:1455 page — paste its full URL into the field above.',
        oauthHint: 'Opens auth.openai.com to sign in with ChatGPT; tokens are filled in automatically and rotated on expiry. If the browser is not on the same machine as WeKnora, paste the final localhost:1455 URL into the field that appears.',
        oauthPastePlaceholder: 'Redirect to localhost:1455 unreachable? Paste the full URL from the address bar here',
        ...
        authJsonLabel: 'Or import manually from ~/.codex/auth.json',
  ...
  agentEditor: {
    ...
    im: {
      ...
      whatsappQRExpired: 'QR code expired, click to refresh',
      whatsappAllowFrom: 'DM allowlist',
      whatsappAllowFromHint: 'Comma-separated phone numbers (with country code, e.g. 8613800138000) allowed to trigger the bot in direct chats; "*" allows everyone, empty rejects all DMs. In groups the bot responds when {\'@\'}mentioned or when a member replies to its message.',
      statusConnected: 'Connected',
      statusConnecting: 'Connecting…',
      statusLoggedOut: 'Pairing revoked — re-pair required',
      statusNeedsPairing: 'Not paired — scan the QR code',
      statusStreamReplaced: 'Session taken over by another client',
