export default {
  ...
  agentEditor: {
    ...
    im: {
      ...
      whatsappQRExpired: '二维码已过期，点击刷新',
      whatsappAllowFrom: '私聊白名单',
      whatsappAllowFromHint: '允许私聊触发机器人的号码列表（逗号分隔，含国家码，如 8613800138000）；填 * 允许所有人，留空则拒绝所有私聊。群聊中在 {\'@\'}机器人 或回复机器人消息时响应。',
      statusConnected: '已连接',
      statusConnecting: '连接中…',
      statusLoggedOut: '配对已失效，请重新配对',
      statusNeedsPairing: '未配对，请扫码配对',
      statusStreamReplaced: '会话被其他客户端接管',
  ...
  model: {
    ...
    editor: {
      ...
      codex: {
        ...
        oauthLabel: 'ChatGPT 授权',
        oauthButton: '使用 ChatGPT 账号授权',
        oauthButtonAgain: '重新授权',
        oauthWaiting: '已打开授权页，请在弹出窗口完成 ChatGPT 登录…',
        oauthSuccess: '已授权 {account}，令牌已自动填入',
        oauthSuccessSaved: '已授权 {account}，凭证已保存到该模型',
        oauthSuccessNoProfile: '授权成功，令牌已自动填入',
        oauthCredentialSaved: '凭证已更新（Access Token + Refresh Token）',
        oauthFailed: '授权失败，请重试',
        oauthExpired: '授权流程已过期，请重新点击授权',
        oauthTimeout: '等待授权超时，请重新点击授权',
        oauthListenerDown: '后端未能监听 localhost:1455（端口被占用？）。完成登录后浏览器会停在打不开的 localhost:1455 页面，把地址栏完整 URL 粘贴到上方输入框即可。',
        oauthHint: '将打开 auth.openai.com 完成 ChatGPT 登录，成功后自动填入令牌并在过期时自动轮换。若浏览器与 WeKnora 不在同一台机器，登录后把跳转的 localhost:1455 地址粘贴到出现的输入框。',
        oauthPastePlaceholder: '浏览器跳转 localhost:1455 打不开？把地址栏完整 URL 粘贴到这里',
        oauthPasteSubmit: '提交',
        refreshTokenLabel: 'Refresh Token',
        refreshTokenPlaceholder: '输入 refresh_token（access token 过期后自动续期）',
        authJsonLabel: '或从 ~/.codex/auth.json 手动导入',
  ...
  chat: {
    ...
    channelApi: 'API',
    channelIm: 'IM',
    channelImTakeover: '人工接管期间',
    imManualBanner: '来自 {platform} 的会话：这里发送的内容将以人工身份直接发给对方，不触发 AI 回答',
    imManualSent: '已发送给对方',
    imManualSendFailed: '人工回复发送失败',
    imManualTag: '人工回复',
    imManualImageNoPreview: '图片 {name} 已发送（超出预览大小，未保存预览）',
    imTakeoverStart: '接管会话',
    imTakeoverRelease: '交还机器人',
    imTakeoverActive: '人工接管中：机器人已静默，此对话由您回复',
    imTakeoverActiveUntil: '人工接管中：机器人已静默，{time} 前无人工回复将自动恢复',
    imTakeoverFor30m: '接管 30 分钟',
    imTakeoverFor1h: '接管 1 小时',
    imTakeoverFor4h: '接管 4 小时',
    imTakeoverIndefinite: '接管直到手动交还',
    imTakeoverStarted: '已接管，机器人在此对话中静默',
    imTakeoverReleased: '已交还机器人',
    imTakeoverFailed: '接管状态更新失败',
    chunkLabel: '片段{index}:',
  ...
  input: {
    ...
    placeholderManualIm: '输入人工回复，发送后对方将直接收到',
  ...
  imInbox: {
    title: 'IM 收件箱',
    unreadTotalTip: '未读消息总数',
    filterAll: '全部',
    filterHuman: '待人工',
    filterUnread: '未读',
    empty: '暂无 IM 会话',
    emptyFiltered: '没有符合条件的会话',
    loading: '加载中…',
    loadMore: '加载更多',
    loadOlder: '加载更早的消息',
    selectPrompt: '在左侧选择一个会话开始处理',
    humanTag: '人工接管中',
    roleUser: '用户',
    roleAssistant: '机器人',
    roleOperator: '客服',
    takeover: '接管会话',
    takeover30m: '接管 30 分钟',
    takeover1h: '接管 1 小时',
    takeover4h: '接管 4 小时',
    takeoverNoExpiry: '接管直到手动交还',
    takeoverActive: '人工接管中，{time} 到期',
    takeoverActiveNoExpiry: '人工接管中',
    takeoverStarted: '已接管会话，机器人已静默',
    takeoverReleased: '已交还机器人',
    takeoverRelease: '交还机器人',
    openInChat: '在对话页打开',
    composerPlaceholder: '输入回复内容，Enter 发送，Shift+Enter 换行',
    composerUnsupported: '该平台暂不支持在控制台直接回复，请在对应 IM 平台处理',
    send: '发送',
    sendFailed: '发送失败，请稍后再试',
    actionFailed: '操作失败，请稍后再试',
    loadFailed: '加载失败，请稍后再试',
    quickReplies: '快捷短语',
    quickRepliesManage: '管理快捷短语',
    quickRepliesHint: '每行一条短语，最多 50 条，每条不超过 500 字；工作空间内全部运营者共享。',
    quickRepliesPlaceholder: '例如：您好，请问有什么可以帮您？',
    quickRepliesSaved: '快捷短语已保存',
    save: '保存',
    cancel: '取消',
    channelTakeover: '人工接管期间',
    channelManual: '人工客服',
  },
  menu: {
    knowledgeBase: '知识库',
