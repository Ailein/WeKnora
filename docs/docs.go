    ...
    "paths": {
        ...
        "/im-analytics": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "统计天数（含今天，1-90，默认 7）",
                        "name": "days",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "查看者相对 UTC 的偏移分钟数（东为正，默认 0）",
                        "name": "tz_offset_minutes",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "仅统计指定 IM 渠道",
                        "name": "im_channel_id",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "看板数据（totals/daily/channels/top_users）",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/im-channels/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "更新字段（name/mode/output_mode/knowledge_base_id/credentials/handoff_config/enabled）",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/im-channels/{id}/status": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "状态（state/detail/since）",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/im-inbox": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "过滤：human（人工接管中）/ unread（有未读），默认全部",
                        "name": "filter",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "仅列出指定 IM 渠道",
                        "name": "im_channel_id",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "integer",
                        "description": "每页数量（默认 100，最大 200）",
                        "name": "page_size",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "items/total/unread_total",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/im-inbox/sessions/{session_id}/read": {
            "post": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/models/codex/available-models": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "{model_id?: string, access_token?: string}",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "{models: [{name, display_name, vision}], source: upstream|static}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/whatsapp/qrcode": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "配对会话（session_id + qr_png）",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
    ...
    "definitions": {
        ...
        "internal_handler.ModelTestRequest": {
            ...
            "properties": {
                ...
                "refreshToken": {
                    "description": "RefreshToken 用于 OAuth 型厂商（OpenAI Codex / ChatGPT 订阅），\n此时 apiKey 承载 access token（对应模型 Parameters.RefreshToken）。",
                    "type": "string"
                },
                "source": {
