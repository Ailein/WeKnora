-- Rollback: 000087_im_inbox
DO $$ BEGIN RAISE NOTICE '[Migration 000087] Dropping IM operator inbox columns'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000087] IM operator inbox columns dropped'; END $$;
