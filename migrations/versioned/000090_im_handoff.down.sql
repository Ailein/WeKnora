...
DO $$ BEGIN RAISE NOTICE '[Migration 000090] Dropping IM handoff trigger columns'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000090] IM handoff trigger columns dropped'; END $$;
