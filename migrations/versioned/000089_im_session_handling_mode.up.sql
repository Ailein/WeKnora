...
DO $$ BEGIN RAISE NOTICE '[Migration 000089] Adding IM session handling (human takeover) columns'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000089] IM session handling columns added'; END $$;
