...
-- the inbox composer.
DO $$ BEGIN RAISE NOTICE '[Migration 000087] Adding IM operator inbox columns'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000087] IM operator inbox columns added'; END $$;
