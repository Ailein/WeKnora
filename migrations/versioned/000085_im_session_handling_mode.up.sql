-- Migration: 000085_im_session_handling_mode
...
DO $$ BEGIN RAISE NOTICE '[Migration 000085] Adding IM session handling (human takeover) columns'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000085] IM session handling columns added'; END $$;
