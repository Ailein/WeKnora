...
DO $$ BEGIN RAISE NOTICE '[Migration 000093] Adding IM handoff trigger columns'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000093] IM handoff trigger columns added'; END $$;
