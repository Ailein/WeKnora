...
-- the inbox composer.
DO $$ BEGIN RAISE NOTICE '[Migration 000094] Adding IM operator inbox columns'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000094] IM operator inbox columns added'; END $$;
