...
DO $$ BEGIN RAISE NOTICE '[Migration 000086] Adding IM handoff trigger columns'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000086] IM handoff trigger columns added'; END $$;
