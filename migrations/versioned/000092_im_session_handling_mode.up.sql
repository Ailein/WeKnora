-- Migration: 000092_im_session_handling_mode
...
DO $$ BEGIN RAISE NOTICE '[Migration 000092] Adding IM session handling (human takeover) columns'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000092] IM session handling columns added'; END $$;
