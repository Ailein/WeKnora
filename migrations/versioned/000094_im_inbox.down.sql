-- Rollback: 000094_im_inbox
DO $$ BEGIN RAISE NOTICE '[Migration 000094] Dropping IM operator inbox columns'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000094] IM operator inbox columns dropped'; END $$;
